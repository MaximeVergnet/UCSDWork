 ...
 * @author Maxime Vergnet
 */
public class Gryphon extends Monster implements Winged{
    
    private static final double ADD_POWER = 20.0;
    private static final int HALF = 2;

    /**
     * No args constructor for the Gryphon class
     */
    public Gryphon(){
        super();
    }
    ...
    /**
     * Constructor for the Gryphon class. Assigns the parameter to the instance
     * variables
    ...
    public void strafe(Monster monster){
        setPower(getPower() + monster.getPower()/HALF);
    }
}
